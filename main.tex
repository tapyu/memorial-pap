...
Dado o atual cenário socio-econômico-industrial do estado do Rio Grande do Norte, do Nordeste e do Brasil, e considerando as forças, fraquezas, oportunidades e ameaças apresentadas na Tabela~\ref{tab:ppgeec}, os objetivos do meu \cgls{pap} são os seguintes:
...
\section{Plano detalhado das atividades que pretendo desempenhar na UFRN}

Explana-se nessa seção o plano de ação para alcançar os objetivos propostos na Seção \ref{sec:objetivos}. As atividades aqui apresentadas perparsa por todas as áreas de atuação do magistério, isto é, ensino, pesquisa, extensão e gestão.
...
\subsubsection{Projetos e versionamento de código}
...
\subsubsection{Linguagens de programação priorizadas}
...
\subsubsection{Critério de avaliação}
...
\subsubsection{Material usado em sala de aula}
...
\subsubsection{Propostas de projetos e ferramentas por disciplina}
...
\subsubsection{Metodologia de ensino de pós-graduação}
...
\section{Resultados esperados} % Desdobramentos e consequências
