...
\begin{itemize}
  ...
  \item Em 2017, foi celebrado um acordo de acolhimento entre a \cgls{ufc} e o \cgls{dlr}, que permitiu com que fosse instalado equipamentos para o monitoramento da cintilação ionosférica. O \cgls{dlr} entrava com os equipamentos e a \cgls{ufc} entrava com o espaço físico. Uma antena foi instalada no topo (\textit{vide} Figura \ref{fig:antena}) do prédio do \cgls{deti} e um espaço físico foi destinado para acomodar os equipamentos (\textit{vide} Figura \ref{fig:bancada}) e as atividades de pesquisa do grupo. Do lado da \cgls{ufc}, o responsável pelo acordo ficou no nome do Prof. Dr. João Cesar Moura, e do \cgls{dlr}, o Prof. Dr. Friederike Fohlmeister. O monitoramento da cintilação ionosférica é realizado por meio da análise de sinais \cgls{gnss}, coletados por meio dos receptores instalados, utilizando técnicas de processamento de sinais e inteligência artificial para detectar e caracterizar o fenômeno e desenvolver estratégias de mitigação. A Figura \ref{fig:coleta} apresenta um esquema do sistema de coleta e aquisição de dados utilizado no monitoramento da cintilação ionosférica.
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Programa: \glsentrylong{ppgeti};
    \item Orientador: Prof. Dr. João Cesar Moura Mota (\glsentrylong{ufc});
