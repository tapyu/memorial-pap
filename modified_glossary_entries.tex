...
\newglossaryentry{cnn}{
  type=\acronymtype,
  name={CNN},
  description={Rede neural convolucional},
  first={rede neural convolucional (CNN ou ConvNet)},
  firstplural={redes neurais convolucionais (CNNs ou ConvNets)},
  sort={CNN},
...
\newglossaryentry{fpga}{
  type=\acronymtype,
  name={FPGA},
  description={\textit{Field programmable gate array}},
  first={FPGA (\textit{field programmable gate array})},
  sort={FPGA},
  long={\textit{field programmable gate array}},
  short={FPGA},
}
\newglossaryentry{fs}{
  type=\acronymtype,
