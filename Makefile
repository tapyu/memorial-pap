...
SHELL := /usr/bin/zsh
# you should change the main LaTeX basename if it is not "main.tex". Don't include the ".tex" entension.
BASENAME=main
# pdflatex, xelatex, lualatex, latexmk
LATEX_ENGINE=pdflatex
# LaTeX flags
LATEX_FLAGS=--shell-escape -synctex=1 -interaction=nonstopmode -file-line-error
# bibtex biber
BIB_PROCESSOR=biber
