...
Até o fim deste documento, explana-se um plano de ação para alcançar os objetivos propostos nesta Seção. As atividades aqui apresentadas perpassa por todas as áreas de atuação do magistério, isto é, ensino, pesquisa, extensão e gestão.
...
\subsection{Explorando parcerias do estado do Rio Grande do Norte}
