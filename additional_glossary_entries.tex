...
\newglossaryentry{cbcd}{
  type=\acronymtype,
  name={CBCD},
  description={Centro Brasileiro de Coleta de Dados Ambientais por Satélite},
  first={CBCD (Centro Brasileiro de Coleta de Dados Ambientais por Satélite)},
  sort={CBCD},
  long={Centro Brasileiro de Coleta de Dados Ambientais por Satélite},
  short={CBCD},
}
...
\newglossaryentry{unifor}{
  ...
  long={Universidade de Fortaleza},
  sort={UNIFOR}
}
...
\newglossaryentry{ufc}{
  ...
  long={Universidade Federal do Ceará},
  sort={UFC}
}
...
\newglossaryentry{gage}{
  ...
  long={Research group of Astronomy and GEomatics},
  sort={gAGE}
}
...
\newglossaryentry{ppgeti}{
  ...
  long={Programa de Pós-Graduação em Engenharia de Teleinformática},
  sort={PPGETI}
}
...
\newglossaryentry{lasp}{
  ...
  long={Laboratory of Signal Processing and Applications},
  sort={LASP}
}
...
\newglossaryentry{pgeec}{
  ...
  \newglossaryentry{inpe}{
    ...
    long={Instituto Nacional de Pesquisas Espaciais},
    sort={INPE}
  }
...
\newglossaryentry{embraer}{
  type=\acronymtype,
  name={EMBRAER},
  description={Empresa Brasileira de Aeron\'autica S.A.},
  first={EMBRAER (Empresa Brasileira de Aeron\'autica S.A.)},
  sort={EMBRAER},
  long={Empresa Brasileira de Aeron\'autica S.A.},
  short={EMBRAER},
}
\newglossaryentry{ird}{
  name={IRD},
...
\newglossaryentry{lesc}{
  type=\acronymtype,
  name={LESC},
  description={Laboratório de Engenharia de Sistemas de Computação},
  first={LESC (Laboratório de Engenharia de Sistemas de Computação)},
  sort={LESC},
  long={Laboratório de Engenharia de Sistemas de Computação},
  short={LESC},
}


  \newglossaryentry{embrapii}{
    type=\acronymtype,
    name={EMBRAPII},
    description={Associação Brasileira de Pesquisa e Inovação Industrial},
    first={EMBRAPII (Associação Brasileira de Pesquisa e Inovação Industrial)},
    sort={EMBRAPII},
    long={Associação Brasileira de Pesquisa e Inovação Industrial},
    short={EMBRAPII},
  }

    \newglossaryentry{gtel}{
      type=\acronymtype,
      name={GTEL},
      description={Grupo de Pesquisa em Telecomunica\c{c}\~oes Sem Fio},
      first={GTEL (Grupo de Pesquisa em Telecomunica\c{c}\~oes Sem Fio)},
      sort={GTEL},
      long={Grupo de Pesquisa em Telecomunica\c{c}\~oes Sem Fio},
      short={GTEL},
    }
...
\newglossaryentry{crn}{
  type=\acronymtype,
  name={CRN},
  description={Centro Regional do Nordeste},
  first={CRN (Centro Regional do Nordeste)},
  sort={CRN},
  long={Centro Regional do Nordeste},
  short={CRN},
}

\newglossaryentry{conasat}{
  type=\acronymtype,
  name={CONASAT},
  description={Constelação de Nanossatélites Ambientais},
  first={CONASAT (Constelação de Nanossatélites Ambientais)},
  sort={CONASAT},
  long={Constelação de Nanossatélites Ambientais},
  short={CONASAT},
}

\newglossaryentry{crea}{
  type=\acronymtype,
  name={CREA},
  description={Conselho Regional de Engenharia e Agronomia},
  first={CREA (Conselho Regional de Engenharia e Agronomia)},
  sort={CREA},
  long={Conselho Regional de Engenharia e Agronomia},
  short={CREA},
}

\newglossaryentry{ifce}{
  type=\acronymtype,
  name={IFCE},
  description={Instituto Federal de Educa\c{c}\~ao, Ci\^encia e Tecnologia do Cear\'a},
  first={IFCE (Instituto Federal de Educa\c{c}\~ao, Ci\^encia e Tecnologia do Cear\'a)},
  sort={IFCE},
  long={Instituto Federal de Educa\c{c}\~ao, Ci\^encia e Tecnologia do Cear\'a},
  short={IFCE},
}
  ...
  \newglossaryentry{imd}{
    type=\acronymtype,
    name={IMD},
    description={Instituto Metr\'opole Digital},
    first={IMD (Instituto Metr\'opole Digital)},
    sort={IMD},
    long={Instituto Metr\'opole Digital},
    short={IMD},
  }
